...
void myproject(
    ...
    if (!loaded_weights) {
        ...
        nnet::load_weights_from_txt<weight12_t, 24>(w12, "w12.txt");
        nnet::load_weights_from_txt<bias12_t, 8>(b12, "b12.txt");
        nnet::load_weights_from_txt<weight17_t, 7936>(w17, "w17.txt");
    ...
    nnet::pooling2d_cl<layer9_t, layer11_t, config11>(layer9_out, layer11_out); // pool2d
