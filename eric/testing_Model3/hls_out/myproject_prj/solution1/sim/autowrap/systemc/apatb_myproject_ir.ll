; ModuleID = '/home/youeric/PixelML/SmartpixReal/Muon_Collider_Smart_Pixels/eric/testing_Model3/hls_out/myproject_prj/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_myproject_ir(%"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"* noalias nonnull readonly "fpga.decayed.dim.hint"="273" %cluster, %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="1" %nModule, %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="1" %x_local, %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="1" %y_local, %"struct.ap_fixed<8, 1, AP_RND_CONV, AP_SAT, 0>"* noalias nocapture nonnull "fpga.decayed.dim.hint"="1" "partition" %layer25_out) local_unnamed_addr #0 {
entry:
  ...
  call void @copy_in([273 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* nonnull %0, i4368* nonnull align 512 %cluster_copy7, [1 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* nonnull %1, i16* nonnull align 512 %nModule_copy8, [1 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* nonnull %2, i16* nonnull align 512 %x_local_copy9, [1 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* nonnull %3, i16* nonnull align 512 %y_local_copy10, [1 x %"struct.ap_fixed<8, 1, AP_RND_CONV, AP_SAT, 0>"]* nonnull %4, i8* nonnull align 512 %layer25_out_copy6)
  call void @apatb_myproject_hw(i4368* %cluster_copy7, i16* %nModule_copy8, i16* %x_local_copy9, i16* %y_local_copy10, i8* %layer25_out_copy6)
  call void @copy_back([273 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %0, i4368* %cluster_copy7, [1 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %1, i16* %nModule_copy8, [1 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %2, i16* %x_local_copy9, [1 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %3, i16* %y_local_copy10, [1 x %"struct.ap_fixed<8, 1, AP_RND_CONV, AP_SAT, 0>"]* %4, i8* %layer25_out_copy6)
  ret void
}
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a1struct.ap_fixed<8, 1, AP_RND_CONV, AP_SAT, 0>.153"([1 x %"struct.ap_fixed<8, 1, AP_RND_CONV, AP_SAT, 0>"]* "orig.arg.no"="0" "unpacked"="0" %dst, i8* nocapture readonly "orig.arg.no"="1" "unpacked"="1.0" %src, i64 "orig.arg.no"="2" "unpacked"="2" %num) #1 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @"onebyonecpy_hls.p0a1struct.ap_fixed<8, 1, AP_RND_CONV, AP_SAT, 0>.150"([1 x %"struct.ap_fixed<8, 1, AP_RND_CONV, AP_SAT, 0>"]* noalias "orig.arg.no"="0" "unpacked"="0" %dst, i8* noalias nocapture readonly align 512 "orig.arg.no"="1" "unpacked"="1.0" %src) #2 {
entry:
  %0 = icmp eq [1 x %"struct.ap_fixed<8, 1, AP_RND_CONV, AP_SAT, 0>"]* %dst, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a1struct.ap_fixed<8, 1, AP_RND_CONV, AP_SAT, 0>.153"([1 x %"struct.ap_fixed<8, 1, AP_RND_CONV, AP_SAT, 0>"]* nonnull %dst, i8* %src, i64 1)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a1struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>.163"(i16* nocapture "orig.arg.no"="0" "unpacked"="0.0" %dst, i64 %dst_shift, [1 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* readonly "orig.arg.no"="1" "unpacked"="1" %src, i64 "orig.arg.no"="2" "unpacked"="2" %num) #1 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @"onebyonecpy_hls.p0a1struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>.160"(i16* noalias nocapture align 512 "orig.arg.no"="0" "unpacked"="0.0" %dst, [1 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* noalias readonly "orig.arg.no"="1" "unpacked"="1" %src) #2 {
entry:
  %0 = icmp eq [1 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %src, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a1struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>.163"(i16* %dst, i64 0, [1 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* nonnull %src, i64 1)
  br label %ret
...
entry:
  ...
  call void @"onebyonecpy_hls.p0a1struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>.160"(i16* align 512 %3, [1 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %2)
  call void @"onebyonecpy_hls.p0a1struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>.160"(i16* align 512 %5, [1 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %4)
  call void @"onebyonecpy_hls.p0a1struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>.160"(i16* align 512 %7, [1 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %6)
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a273struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>.188"([273 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* "orig.arg.no"="0" "unpacked"="0" %dst, i4368* nocapture readonly "orig.arg.no"="1" "unpacked"="1.0" %src, i64 %src_shift, i64 "orig.arg.no"="2" "unpacked"="2" %num) #1 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @"onebyonecpy_hls.p0a273struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>.185"([273 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* noalias "orig.arg.no"="0" "unpacked"="0" %dst, i4368* noalias nocapture readonly align 512 "orig.arg.no"="1" "unpacked"="1.0" %src) #2 {
entry:
  %0 = icmp eq [273 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %dst, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a273struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>.188"([273 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* nonnull %dst, i4368* %src, i64 0, i64 273)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a1struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>.170"([1 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* "orig.arg.no"="0" "unpacked"="0" %dst, i16* nocapture readonly "orig.arg.no"="1" "unpacked"="1.0" %src, i64 %src_shift, i64 "orig.arg.no"="2" "unpacked"="2" %num) #1 {
entry:
...
copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a1struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>.170"([1 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* nonnull %dst, i16* %src, i64 0, i64 1)
  br label %ret
...
entry:
  call void @"onebyonecpy_hls.p0a273struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>.185"([273 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %0, i4368* align 512 %1)
  ...
  call void @"onebyonecpy_hls.p0a1struct.ap_fixed<8, 1, AP_RND_CONV, AP_SAT, 0>.150"([1 x %"struct.ap_fixed<8, 1, AP_RND_CONV, AP_SAT, 0>"]* %8, i8* align 512 %9)
  ret void
}
...
entry:
  ...
  call void @copy_out([273 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %5, i4368* %0, [1 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %6, i16* %1, [1 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %7, i16* %2, [1 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %8, i16* %3, [1 x %"struct.ap_fixed<8, 1, AP_RND_CONV, AP_SAT, 0>"]* %9, i8* %4)
  ...
  call void @copy_in([273 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %5, i4368* %0, [1 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %6, i16* %1, [1 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %7, i16* %2, [1 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %8, i16* %3, [1 x %"struct.ap_fixed<8, 1, AP_RND_CONV, AP_SAT, 0>"]* %9, i8* %4)
  ret void
}

declare void @myproject_hw_stub(%"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"* noalias nonnull readonly, %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"* noalias nocapture nonnull readonly, %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"* noalias nocapture nonnull readonly, %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"* noalias nocapture nonnull readonly, %"struct.ap_fixed<8, 1, AP_RND_CONV, AP_SAT, 0>"* noalias nocapture nonnull)
