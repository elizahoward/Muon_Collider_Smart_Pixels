...
begin
    ...
    ap_block_state1_assign_proc : process(ap_start, ap_done_reg, nModule_ap_vld, x_local_ap_vld)
    begin
                ap_block_state1 <= ((ap_start = ap_const_logic_0) or (x_local_ap_vld = ap_const_logic_0) or (nModule_ap_vld = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1));
    end process;
    ...
    ap_return_0_assign_proc : process(ap_ce, ap_CS_fsm_state1, nModule, ap_block_state1, ap_return_0_preg)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_logic_1 = ap_ce))) then 
            ap_return_0 <= nModule;
        else 
    ...
    ap_return_1_assign_proc : process(ap_ce, ap_CS_fsm_state1, x_local, ap_block_state1, ap_return_1_preg)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_logic_1 = ap_ce))) then 
            ap_return_1 <= x_local;
        else 
    ...
    nModule_blk_n_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, nModule_ap_vld)
    begin
    ...
    x_local_blk_n_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, x_local_ap_vld)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
