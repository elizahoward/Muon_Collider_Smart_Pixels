...
entity myproject_fifo_w16_d3_S is 
    generic (
...
architecture rtl of myproject_fifo_w16_d3_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component myproject_fifo_w16_d3_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 16;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 3);
...
begin
----------------------- Instantiation -----------------------
    U_myproject_fifo_w16_d3_S_ShiftReg : myproject_fifo_w16_d3_S_ShiftReg
    generic map (
...
entity myproject_fifo_w16_d3_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 16;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 3);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end myproject_fifo_w16_d3_S_ShiftReg;

architecture rtl of myproject_fifo_w16_d3_S_ShiftReg is
