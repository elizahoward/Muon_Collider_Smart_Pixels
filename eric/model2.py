...
class Model2(SmartPixModel):
    ...
    def __init__(self,
                 tfRecordFolder: str = "/local/d1/smartpixML/filtering_models/shuffling_data/filtering_records1024_data_shuffled_single/",
                 nBits: list = None,
    ...
    def makeQuantizedModel(self, bit_configs=None):
        ...
        for weight_bits, int_bits in bit_configs:
            ...
            activation_quantizer = quantized_relu(weight_bits, int_bits)
    ...
    def trainModel(self, epochs=100, batch_size=32, learning_rate=1e-3, 
        ...
        if save_best:
            callbacks.append(ModelCheckpoint(
                filepath=f'./{self.modelName}_best.keras',
    ...
    def runAllStuff(self):
        """
        Run the complete Model2 pipeline: build, train, evaluate, and plot.
        """
        print("=== Running Complete Model2 Pipeline ===")
        ...
        print("2. Building unquantized model...")
        self.buildModel("unquantized")
        
        # Train model
        print("3. Training model...")
        self.trainModel(epochs=50, early_stopping_patience=15)
        ...
        print("=== Model2 Pipeline Completed! ===")
        return self.training_history, self.evaluation_results
...
def main():
    ...
    # Initialize Model2
    model2 = Model2(
        tfRecordFolder="/local/d1/smartpixML/filtering_models/shuffling_data/filtering_records1024_data_shuffled_single/",
        dropout_rate=0.1
    )
    
    # Run complete pipeline
    history, results = model2.runAllStuff()
    
    print("Model2 training and evaluation completed successfully!")
