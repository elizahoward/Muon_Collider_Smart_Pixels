...
void myproject(
    ...
    if (!loaded_weights) {
        ...
        nnet::load_weights_from_txt<weight15_t, 231680>(w15, "w15.txt");
        nnet::load_weights_from_txt<bias15_t, 80>(b15, "b15.txt");
        nnet::load_weights_from_txt<weight18_t, 2560>(w18, "w18.txt");
