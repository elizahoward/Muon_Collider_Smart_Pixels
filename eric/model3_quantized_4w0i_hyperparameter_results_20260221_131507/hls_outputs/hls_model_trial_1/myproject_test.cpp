...
int main(int argc, char **argv) {
    ...
    if (fin.is_open() && fpr.is_open()) {
      ...
      input5_t z_global[N_INPUT_1_5];
      nnet::copy_data<float, input5_t, 273, N_INPUT_1_5>(in, z_global);
      input6_t y_local[N_INPUT_1_6];
      nnet::copy_data<float, input6_t, 274, N_INPUT_1_6>(in, y_local);
      result_t layer23_out[N_LAYER_21];

            // hls-fpga-machine-learning insert top-level-function
            myproject(cluster,z_global,y_local,layer23_out);
    ...
    input5_t z_global[N_INPUT_1_5];
    nnet::fill_zero<input5_t, N_INPUT_1_5>(z_global);
    input6_t y_local[N_INPUT_1_6];
