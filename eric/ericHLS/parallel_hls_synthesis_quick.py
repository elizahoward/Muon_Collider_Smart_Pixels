#!/usr/bin/env python3
"""
Parallel HLS Synthesis Script (Quick / Low-IR variant)

Same as parallel_hls_synthesis.py but uses:
...
Usage:
    python parallel_hls_synthesis_quick.py --input_dir <path_to_h5_files> --num_workers <workers> [options]
...
def main():
    parser = argparse.ArgumentParser(
        description='Parallel HLS Synthesis for Neural Network Models (quick/low-IR mode)',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  # Synthesize all models in a directory with 4 workers
  python parallel_hls_synthesis_quick.py --input_dir ../model3_4bit__pareto_roc_selected --num_workers 4

  # Synthesize specific trials only
  python parallel_hls_synthesis_quick.py --input_dir ../model3_results --pattern "model_trial_00*.h5" --num_workers 2

  # Use different FPGA part
  python parallel_hls_synthesis_quick.py --input_dir ../model3_results --num_workers 4 --fpga_part xcu250-figd2104-2L-e
        """
    )
    ...
    print(f"Strategy: Resource (all layers)")
    print(f"ReuseFactor: 64 (Conv layers) / 8 (Dense layers)")
    print(f"io_type: io_parallel")
    print("-" * 80)
