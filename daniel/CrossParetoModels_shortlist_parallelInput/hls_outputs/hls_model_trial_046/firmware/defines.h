...
#define N_SIZE_0_18 120
#define N_LAYER_16 16
#define OUT_CONCAT_20 136
#define N_LAYER_21 72
#define N_LAYER_21 72
#define N_LAYER_24 58
#define N_LAYER_24 58
#define N_LAYER_27 1
#define N_LAYER_27 1
...
typedef ap_fixed<10,1> weight16_t;
typedef ap_fixed<10,1> bias16_t;
...
typedef ap_fixed<10,1> weight21_t;
typedef ap_fixed<10,1> bias21_t;
...
typedef ap_fixed<10,1> weight24_t;
typedef ap_fixed<10,1> bias24_t;
...
typedef ap_fixed<10,1> weight27_t;
typedef ap_fixed<10,1> bias27_t;
