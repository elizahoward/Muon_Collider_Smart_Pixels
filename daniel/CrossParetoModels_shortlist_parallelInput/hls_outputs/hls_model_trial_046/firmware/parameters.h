...
struct relu_config13 : nnet::activ_config {
    static const unsigned n_in = 546;
    static const unsigned table_size = 1024;
    static const unsigned io_type = nnet::io_parallel;
...
struct config20 : nnet::concat_config {
    static const unsigned n_elem1_0 = 120;
    static const unsigned n_elem1_1 = 0;
    static const unsigned n_elem1_2 = 0;
...
struct config21 : nnet::dense_config {
    ...
    static const unsigned io_type = nnet::io_parallel;
    static const unsigned strategy = nnet::resource;
    static const unsigned reuse_factor = 17;
    static const unsigned n_zeros = 34;
    static const unsigned n_nonzeros = 9758;
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    static const bool store_weights_in_bram = false;
    typedef model_default_t accum_t;
...
struct config24 : nnet::dense_config {
    ...
    static const unsigned n_nonzeros = 4168;
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    static const bool store_weights_in_bram = false;
    typedef model_default_t accum_t;
...
struct config27 : nnet::dense_config {
    ...
    static const unsigned io_type = nnet::io_parallel;
    static const unsigned strategy = nnet::resource;
    static const unsigned reuse_factor = 29;
    static const unsigned n_zeros = 0;
