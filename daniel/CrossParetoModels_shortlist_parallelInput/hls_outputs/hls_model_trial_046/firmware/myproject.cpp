...
void myproject(
    ...
    if (!loaded_weights) {
        ...
        nnet::load_weights_from_txt<bias9_t, 2>(b9, "b9.txt");
        nnet::load_weights_from_txt<weight16_t, 48>(w16, "w16.txt");
        nnet::load_weights_from_txt<bias16_t, 16>(b16, "b16.txt");
        nnet::load_weights_from_txt<weight21_t, 9792>(w21, "w21.txt");
        nnet::load_weights_from_txt<bias21_t, 72>(b21, "b21.txt");
        nnet::load_weights_from_txt<weight24_t, 4176>(w24, "w24.txt");
        nnet::load_weights_from_txt<bias24_t, 58>(b24, "b24.txt");
        nnet::load_weights_from_txt<weight27_t, 58>(w27, "w27.txt");
