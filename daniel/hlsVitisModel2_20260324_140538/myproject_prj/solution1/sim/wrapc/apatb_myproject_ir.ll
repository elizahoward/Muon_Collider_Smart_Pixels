; ModuleID = '/home/dabadjiev/smartpixels_ml_dsabadjiev/Muon_Collider_Smart_Pixels/daniel/hlsVitisModel2_20260324_140538/myproject_prj/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  ...
  %5 = bitcast %"struct.ap_fixed<8, 1, AP_TRN, AP_WRAP, 0>"* %layer24_out to [1 x %"struct.ap_fixed<8, 1, AP_TRN, AP_WRAP, 0>"]*
  call void @copy_in([21 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* nonnull %0, i336* nonnull align 512 %x_profile_copy8, [1 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* nonnull %1, i16* nonnull align 512 %nModule_copy9, [1 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* nonnull %2, i16* nonnull align 512 %x_local_copy10, [13 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* nonnull %3, i208* nonnull align 512 %y_profile_copy11, [1 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* nonnull %4, i16* nonnull align 512 %y_local_copy12, [1 x %"struct.ap_fixed<8, 1, AP_TRN, AP_WRAP, 0>"]* nonnull %5, i8* nonnull align 512 %layer24_out_copy7)
  ...
  call void @copy_back([21 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %0, i336* %x_profile_copy8, [1 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %1, i16* %nModule_copy9, [1 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %2, i16* %x_local_copy10, [13 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %3, i208* %y_profile_copy11, [1 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %4, i16* %y_local_copy12, [1 x %"struct.ap_fixed<8, 1, AP_TRN, AP_WRAP, 0>"]* %5, i8* %layer24_out_copy7)
  ret void
}
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a1struct.ap_fixed<8, 1, AP_TRN, AP_WRAP, 0>.112"([1 x %"struct.ap_fixed<8, 1, AP_TRN, AP_WRAP, 0>"]* "orig.arg.no"="0" "unpacked"="0" %dst, i8* nocapture readonly "orig.arg.no"="1" "unpacked"="1.0" %src, i64 "orig.arg.no"="2" "unpacked"="2" %num) #1 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @"onebyonecpy_hls.p0a1struct.ap_fixed<8, 1, AP_TRN, AP_WRAP, 0>.109"([1 x %"struct.ap_fixed<8, 1, AP_TRN, AP_WRAP, 0>"]* noalias "orig.arg.no"="0" "unpacked"="0" %dst, i8* noalias nocapture readonly align 512 "orig.arg.no"="1" "unpacked"="1.0" %src) #2 {
entry:
  %0 = icmp eq [1 x %"struct.ap_fixed<8, 1, AP_TRN, AP_WRAP, 0>"]* %dst, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a1struct.ap_fixed<8, 1, AP_TRN, AP_WRAP, 0>.112"([1 x %"struct.ap_fixed<8, 1, AP_TRN, AP_WRAP, 0>"]* nonnull %dst, i8* %src, i64 1)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a21struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>.159"(i336* nocapture "orig.arg.no"="0" "unpacked"="0.0" %dst, i64 %dst_shift, [21 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* readonly "orig.arg.no"="1" "unpacked"="1" %src, i64 "orig.arg.no"="2" "unpacked"="2" %num) #1 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @"onebyonecpy_hls.p0a21struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>.156"(i336* noalias nocapture align 512 "orig.arg.no"="0" "unpacked"="0.0" %dst, [21 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* noalias readonly "orig.arg.no"="1" "unpacked"="1" %src) #2 {
entry:
  %0 = icmp eq [21 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %src, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a21struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>.159"(i336* %dst, i64 0, [21 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* nonnull %src, i64 21)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a1struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>.122"(i16* nocapture "orig.arg.no"="0" "unpacked"="0.0" %dst, i64 %dst_shift, [1 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* readonly "orig.arg.no"="1" "unpacked"="1" %src, i64 "orig.arg.no"="2" "unpacked"="2" %num) #1 {
entry:
  %0 = icmp eq [1 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %src, null
  br i1 %0, label %ret, label %copy
...
copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a1struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>.122"(i16* %dst, i64 0, [1 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* nonnull %src, i64 1)
  br label %ret
...
entry:
  ...
  call void @"onebyonecpy_hls.p0a1struct.ap_fixed<8, 1, AP_TRN, AP_WRAP, 0>"(i8* align 512 %11, [1 x %"struct.ap_fixed<8, 1, AP_TRN, AP_WRAP, 0>"]* %10)
  ret void
}
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a1struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>.129"([1 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* "orig.arg.no"="0" "unpacked"="0" %dst, i16* nocapture readonly "orig.arg.no"="1" "unpacked"="1.0" %src, i64 %src_shift, i64 "orig.arg.no"="2" "unpacked"="2" %num) #1 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @"onebyonecpy_hls.p0a1struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>.126"([1 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* noalias "orig.arg.no"="0" "unpacked"="0" %dst, i16* noalias nocapture readonly align 512 "orig.arg.no"="1" "unpacked"="1.0" %src) #2 {
entry:
  %0 = icmp eq [1 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %dst, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a1struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>.129"([1 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* nonnull %dst, i16* %src, i64 0, i64 1)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a13struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>.138"([13 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* "orig.arg.no"="0" "unpacked"="0" %dst, i208* nocapture readonly "orig.arg.no"="1" "unpacked"="1.0" %src, i64 %src_shift, i64 "orig.arg.no"="2" "unpacked"="2" %num) #1 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @"onebyonecpy_hls.p0a13struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>.135"([13 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* noalias "orig.arg.no"="0" "unpacked"="0" %dst, i208* noalias nocapture readonly align 512 "orig.arg.no"="1" "unpacked"="1.0" %src) #2 {
entry:
  %0 = icmp eq [13 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %dst, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a13struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>.138"([13 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* nonnull %dst, i208* %src, i64 0, i64 13)
  br label %ret
...
entry:
  ...
  call void @"onebyonecpy_hls.p0a1struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>.126"([1 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %2, i16* align 512 %3)
  call void @"onebyonecpy_hls.p0a1struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>.126"([1 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %4, i16* align 512 %5)
  call void @"onebyonecpy_hls.p0a13struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>.135"([13 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %6, i208* align 512 %7)
  call void @"onebyonecpy_hls.p0a1struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>.126"([1 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %8, i16* align 512 %9)
  call void @"onebyonecpy_hls.p0a1struct.ap_fixed<8, 1, AP_TRN, AP_WRAP, 0>.109"([1 x %"struct.ap_fixed<8, 1, AP_TRN, AP_WRAP, 0>"]* %10, i8* align 512 %11)
  ret void
}
...
entry:
  ...
  %11 = alloca [1 x %"struct.ap_fixed<8, 1, AP_TRN, AP_WRAP, 0>"]
  call void @copy_out([21 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %6, i336* %0, [1 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %7, i16* %1, [1 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %8, i16* %2, [13 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %9, i208* %3, [1 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %10, i16* %4, [1 x %"struct.ap_fixed<8, 1, AP_TRN, AP_WRAP, 0>"]* %11, i8* %5)
  ...
  %17 = bitcast [1 x %"struct.ap_fixed<8, 1, AP_TRN, AP_WRAP, 0>"]* %11 to %"struct.ap_fixed<8, 1, AP_TRN, AP_WRAP, 0>"*
  call void @myproject_hw_stub(%"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"* %12, %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"* %13, %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"* %14, %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"* %15, %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"* %16, %"struct.ap_fixed<8, 1, AP_TRN, AP_WRAP, 0>"* %17)
  call void @copy_in([21 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %6, i336* %0, [1 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %7, i16* %1, [1 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %8, i16* %2, [13 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %9, i208* %3, [1 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %10, i16* %4, [1 x %"struct.ap_fixed<8, 1, AP_TRN, AP_WRAP, 0>"]* %11, i8* %5)
  ret void
}

declare void @myproject_hw_stub(%"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"* noalias nocapture nonnull readonly, %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"* noalias nocapture nonnull readonly, %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"* noalias nocapture nonnull readonly, %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"* noalias nocapture nonnull readonly, %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"* noalias nocapture nonnull readonly, %"struct.ap_fixed<8, 1, AP_TRN, AP_WRAP, 0>"* noalias nocapture nonnull)
